...
<img src="https://pbs.twimg.com/media/GQ8LkgbWoAAqwCN?format=jpg&name=large" width="1012px" heigth="358px" />
...
class BackendDev {
    constructor() {
        ...
        this.techStack = {
            ...
            ApiArq:       ["Rest", "Graphql", "Microservices"],
            DbTools:      ["PostgreSQL","Prisma", "sequelize", "Mysql", "Mongodb"],
